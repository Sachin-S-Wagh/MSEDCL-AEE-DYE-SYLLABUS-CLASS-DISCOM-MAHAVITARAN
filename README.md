...
Course is designed to help both graduate electrical engineers and employed professionals preparing for entry level, promotion exams for AEE , DyE, AE, AND JE posts (https://tinyurl.com/DISCOM-MSEDCL-REGISTER). We specialize in competitive and university exams covering a range of key exams (https://sites.google.com/view/msedcl-syllabus-dye-aee-class) including MSEB/DISCOM/GENCO/TRANSCO, SSC/CGL, MPSC/Technical, RRB, Metro, GATE, IES and campus interviews.
